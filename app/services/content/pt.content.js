    ...
    workplaces: [
      {
        ...
        description: `A BRQ é uma consultoria de desenvolvimento de software especializada em atender empresas do setor
                financeiro. Trabalhei prestando serviço para o Itaú Unibanco, tendo como responsabilidades principais desenvolver
                novas funcionalidades para o aplicativo móvel do banco, utilizando com tudo, tecnologias web. Atualmente trabalho como consultor
                para a Dealertrack, empresa multinacional especializada em tecnologia para o setor automobilístico.`,
        activities: {
          ...
          items: [
            ...
            "componentes web reutilizáveis em Angular2",
            "integração de interfaces web com app nativo em que ela deve ser renderizada",
            "componentes web reutilizáveis em React"
          ]
        },
        deliveries: {
